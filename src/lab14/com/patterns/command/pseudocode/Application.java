package com.patterns.command.pseudocode;
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        app.activeEditor.replaceSelection("Minh");
        System.out.println("selection của editor0 sau khi chọn \"Minh\": " + app.activeEditor.getSelection());
        ...
        app.undoButton.onClick();
        System.out.println("selection của editor1 sau khi bấm nút undo: " + app.activeEditor.getSelection());
        app.activeEditor.replaceSelection("text");
        System.out.println("selection của editor1 sau khi chọn \"text\": " + app.activeEditor.getSelection());
